...
// Global semaphores
sem_t ch1, ch6, ch11;
sem_t ch1_noise_sem, ch6_noise_sem, ch11_noise_sem, ch1_in_use_sem, ch6_in_use_sem, ch11_in_use_sem;
...
int main() {
  ...
  sem_init(&ch1_in_use_sem,0,0);
  sem_init(&ch6_in_use_sem,0,0);
  sem_init(&ch11_in_use_sem,0,0);
  sem_init(&ch1_noise_sem,0,0);
  sem_init(&ch6_noise_sem,0,0);
  sem_init(&ch11_noise_sem,0,0);
